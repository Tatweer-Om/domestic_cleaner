        ...
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block mb-3 align-items-center">
                ...
                <select class="default-select ms-auto me-1 image-select style-2">
                    <option data-thumbnail="images/svg/check-circle 1.svg" data-content="<img src='images/svg/check-circle%201.svg'/>">Recovered</option>
                ...
                <a href="javascript:void(0);" class="btn btn-primary btn-rounded wspace-no ms-2"><i class="las scale5 la-pencil-alt me-2"></i> Edit</a>
            </div>
            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3">
                                    <div class="media align-items-start">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p>795 Folsom Ave, Suite 600 San Francisco, <strong class="text-black">CADGE 94107</strong></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
