                        ...
                        <div class="col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker shift" name="shift"
                                    ...
                                    <option value="">{{ trans('messages.choose', [], session('locale')) }}...</option>
                                    <option value="1">{{ trans('messages.morning', [], session('locale')) }}</option>
                                    <option value="2">{{ trans('messages.evening', [], session('locale')) }}</option>
                                    <option value="3">{{ trans('messages.both', [], session('locale')) }}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-xl-4">
                            <div class="form-group">
                                <label class="col-form-label">
                                    ...
                                    {{ trans('messages.enable_whatsapp', [], session('locale')) }}
                                </label>
