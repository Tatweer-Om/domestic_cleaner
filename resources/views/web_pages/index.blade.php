...
@section('main')
   ...
   #map { height: 600px; width: 100%; }
        .controls { margin: 10px 0; position: relative; }
        input, button { margin: 5px; padding: 8px; }
        .lang-toggle { font-weight: bold; cursor: pointer; color: blue; text-decoration: underline; }
        ...
        #search { width: 100%; padding: 6px; border-radius: 4px; border: 1px solid #ccc; font-size: 14px; }
        #suggestions { 
            position: absolute; 
            top: 100%; 
            left: 0; 
        ...
        @media (max-width: 991px) {
            ...
            .lang-toggle { display: inline-block; margin: 8px 0; }
            #search { font-size: 12px; }
            .btn-success, .btn-outline-success { font-size: 12px; padding: 5px 10px; }
            #suggestions { max-height: 120px; }
            .suggestion-item { font-size: 12px; padding: 5px; }
        }
        .suggestion-item { 
            padding: 8px; 
            cursor: pointer; 
    ...
    <div class="container">
        <div class="wraper">
            <div class="row align-items-center">
                ...
                <!-- Right: Map -->
                <div class="col-lg-5 col-12" style="background-color: #fff;">
                    <div class="controls" >
                        <div id="search-container" style="background-color: #fff;">
                            <label for="search">{{ trans('messages.search_location', [], session('locale')) }}</label>
                            <input type="text" id="search" placeholder="{{ trans('messages.enter_location_oman', [], session('locale')) }}" autocomplete="off">
                            <div id="suggestions"></div>
                        </div>
 <div class="d-flex gap-2 flex-wrap">
    <!-- Search Location -->
    <button onclick="searchLocation()" class="btn btn-primary btn-sm d-flex align-items-center shadow-sm px-2 rounded-3">
        <i class="bi bi-search me-1"></i> 
        <span>{{ trans('messages.search', [], session('locale')) }}</span>
    </button>

    <!-- Current Location -->
    <button onclick="getCurrentLocation()" class="btn btn-success btn-sm d-flex align-items-center shadow-sm px-2 rounded-3">
        <i class="bi bi-geo-alt-fill me-1"></i> 
        <span>{{ trans('messages.current_location', [], session('locale')) }}</span>
    </button>

    <!-- Confirm Location -->
    <button id="confirm_location" type="button" class="btn btn-warning btn-sm d-flex align-items-center shadow-sm px-2 rounded-3">
        <i class="bi bi-check-circle-fill me-1"></i> 
        <span>{{ trans('messages.confirm_location', [], session('locale')) }}</span>
    </button>
</div>
                ...
                <div id="map" style="height: 300px; width: 100%; border-radius: 8px; border: 1px solid #e0e0e0;"></div>
                    ...
                    <div class="col-lg-6">
                        <div class="wpo-choose-right-side wow fadeInRightSlow" data-wow-duration="1000ms">
                            <div class="wpo-section-title-s2">
                                ...
                                <h2 class="poort-text poort-in-right">
                            ...
                            <ul>
                                ...
                                <li class="active">
                                    <span>{{ trans('messages.custom_plans', [], session('locale')) }}</span></li>
