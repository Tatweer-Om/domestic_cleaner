                ...
                <div class="hero-form-wrap wow fadeInUp" data-wow-delay="0.75s">
                    <div class="auth-card" id="authCard">
                        <form id="authForm">
                            ...
                            <input type="hidden" hidden name="form_index" id="form_index" value="1">
                                                        <input type="hidden" hidden name="form_1"  value="1">
                ...
                <div class="col-lg-6">
                    <div class="wpo-choose-left-side wow fadeInLeftSlow" data-wow-duration="1000ms">
                        <div class="wpo-choose-left-img left-to-right-light">
                            <img src="{{ asset('images/index.png')}}" alt="index" style="height: 500px; width:500px;">
                        </div>
