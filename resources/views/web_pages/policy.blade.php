                    ...
                    <div class="col col-lg-10 col-12 offset-lg-1">
                        <div class="post format-standard-image">
                            <div class="entry-media">
                                <img src="assets/images/blog-details/img-1.html" alt>
                            </div>
                            {{-- <div class="entry-meta">
                                <ul>
                                    <li><i class="fi flaticon-calendar"></i><a href="#">02 Apr 2025</a>
                                    </li>
                            ...
                            <div class="entry-details">
                                <h3>How To Clean Your Kitchen In 10 Minutes</h3>
                                <p>he whimsically named Egg Canvas is the brainchild of Erica Choi, a design
                                    director
                                    and photo
                                    grapher based in York. Why the name “Egg Canvas Erica was inspired by her
                                    Korean
                                    childhood
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vulputate
                                    vestibulum rhon
                                    cus, dolor eget viverra pretium, dolor tellus aliquet nunc, vitae ultricies
                                    erat
                                    elit eu lacus. Vestibulum non justo fun consectetur, cursus ante, tincidunt
                                    sapien.
                        ...
                        {{-- <div class="post-team-content">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-5 col-12">
                                    <img src="assets/images/blog-details/img-2.html" alt="">
                                </div>
                            </div>
                        </div> --}}
                        {{-- <div class="row">
                            <div class="col-lg-6 col-md-6 col-12 im-1">
                                <img src="assets/images/blog-details/img-3.html" alt="">
                            </div>
                            <div class="col-lg-6 col-md-6 col-12 im-1">
                                <img src="assets/images/blog-details/img-4.html" alt="">
                            </div>
                        </div>
                                        ...
                                        <div id="div-comment-1">
                                            <div class="comment-theme">
                                                <div class="comment-image"><img
                                                        src="assets/images/blog-details/comments-author/img-1.html"
                                                        alt>
                                                </div>
                                            </div>
                                        ...
                                        <ul class="children">
                                            <li class="comment">
                                                <div>
                                                    <div class="comment-theme">
                                                        <div class="comment-image"><img
                                                                src="assets/images/blog-details/comments-author/img-2.html"
                                                                alt></div>
                                                    </div>
                                                    <div class="comment-main-area">
                                                        <div class="comment-wrapper">
                            ...
                            <div class="comment-respond">
                                ...
                                <form id="commentForm" class="comment-form" novalidate>
                                    <div class="form-inputs">
                                        ...
                                        <div>
                                            <input id="email" name="email" placeholder="Enter your mail*"
                                                type="email" required>
                                            <span class="error-message" id="emailError"></span>
                                        </div>
                                        <div>
                                            <input id="phone" name="phone" placeholder="Enter your number*"
                                                type="text" required>
                                            <span class="error-message" id="phoneError"></span>
                                        </div>
                                        <div>
                                            <input id="website" name="website" placeholder="Website*" type="url"
                                                required>
                                            <span class="error-message" id="websiteError"></span>
                                        </div>
                                    </div>
                                    <div class="form-textarea">
                                        <textarea id="comment" name="comment" placeholder="Enter your Message*"
                                            required></textarea>
                                        <span class="error-message" id="commentError"></span>
                                    </div>
                                    <div class="terms">
                                        <input class="checkbox" type="checkbox" id="Insuranceb">
                                        <label for="Insuranceb">Save my name, email, and website in this browser
                                            for the
                                            next time I comment.</label>
                                    </div>
                                    <div class="form-submit">
                                        <input class="theme-btn" id="submit" value="Send Message" type="submit">
                                        <div id="loading" style="display: none;">Submitting, please wait...
                                        </div>
                                    </div>
                                </form>
                            </div>
