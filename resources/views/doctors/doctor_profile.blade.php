        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item  active"><a href="javascript:void(0)">Doctor Details</a></li>
                </ol>
            </div>
            <div class="d-block d-sm-flex mb-3 mb-md-4">
                <a href="javascript:void(0);" class="btn btn-outline-primary btn-rounded mb-2" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="lar la-calendar-plus me-2 scale5 me-2"></i>+ New Appointment</a>
                <select class="default-select ms-auto me-1 image-select style-2">
                    <option data-thumbnail="images/svg/check-circle 1.svg" data-content="<img src='images/svg/check-circle%201.svg'/>">Available</option>
                    <option data-thumbnail="images/svg/check-circle 1.svg" data-content="<img src='images/svg/check-circle%201.svg'/>">Daily</option>
                    <option data-thumbnail="images/svg/check-circle 1.svg" data-content="<img src='images/svg/check-circle%201.svg'/>">Weekly</option>
                    <option data-thumbnail="images/svg/check-circle 1.svg" data-content="<img src='images/svg/check-circle%201.svg'/>">Monthly</option>
                </select>
                <a href="javascript:void(0);" class="btn btn-primary btn-rounded mb-2 ms-2"><i class="las scale5 la-pencil-alt me-2"></i> Edit</a>
            </div>
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-xxl-4">
                    <div class="card">
                        ...
                        <div class="card-body px-0 pt-4">
                            <div id="DZ_W_Todo2" class="widget-media dz-scroll px-4 height370">
                                <ul class="timeline">
                                    <li>
                                        <div class="timeline-panel bgl-dark flex-wrap border-0 p-3 rounded">
                                            <div class="media bg-transparent me-2">
                                            ...
                                            <ul class="mt-3 d-flex flex-wrap text-primary font-w600">
                                                <li class="me-2 fs-15">Sat, 23/08/2020</li>
                                                <li class="fs-15">08:00 - 09:30 AM</li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="media d-sm-flex d-block text-center text-sm-start pb-4 mb-4 border-bottom">
                                <img alt="image" class="rounded me-sm-4 me-0" width="130" src="images/avatar/1.jpg">
                                <div class="media-body align-items-center">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary light btn-rounded mb-2 me-2">
                                        <svg class="me-2 scale5" width="14" height="14" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary light btn-rounded mb-2">
                                        <svg class="me-2 scale5" width="14" height="14" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-lg-6 mb-3">
                                    <div class="media align-items-start">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p>795 Folsom Ave, Suite 600 San Francisco, <strong class="text-dark">CADGE 94107</strong></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6 mb-lg-0 mb-3">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class=" font-w600 mb-0">+00 123 456 7680</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="font-w600 mb-0">info@examle.com</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="assigned-doctor2 owl-carousel">
                        <div class="items">
                            <div class="media bg-white p-4 rounded align-items-center">
                                <img class="me-3" src="images/doctors/6.jpg" alt="">
                                <div class="media-body d-block d-sm-flex  align-items-center justify-content-between">
                                    <div class="me-2">
                                        <h4 class="fs-20"><a class="text-black" href="page-review.html">Glee Smiley</a></h4>
                                    ...
                                    <div class="text-sm-end text-center mt-sm-0 mt-2">
                                        <span class="badge badge-md badge-success fs-16 mb-2">4.0</span>
                        ...
                        <div class="items">
                            <div class="media bg-white p-4 rounded align-items-center">
                                <img class="me-3" src="images/doctors/7.jpg" alt="">
                                <div class="media-body d-block d-sm-flex  align-items-center justify-content-between">
                                    <div class="me-2">
                                        <h4 class="fs-20"><a class="text-black" href="page-review.html">Stevani Anderson</a></h4>
                                        <p class="fs-14 mb-0"> I came with my mother, I was very nervous. But after entering here I felt warmed with smiling</p>
                                    </div>
                                    <div class="text-sm-end text-center mt-sm-0 mt-2">
                                        <span class="badge badge-md badge-success fs-16 mb-2">2.0</span>
                                        <div class="star-icons wspace-no">
                                            <i class="las la-star"></i>
                                            <i class="las la-star"></i>
                                            <i class="las la-star"></i>
                        ...
                        <div class="items">
                            <div class="media bg-white p-4 rounded align-items-center">
                                <img class="me-3" src="images/doctors/8.jpg" alt="">
                                <div class="media-body d-block d-sm-flex  align-items-center justify-content-between">
                                    <div class="me-2">
                                        <h4 class="fs-20"><a class="text-black" href="page-review.html">Cive Slauw</a></h4>
                                        <p class="fs-14 mb-0"> I came with my mother, I was very nervous. But after entering here I felt warmed with smiling</p>
                                    </div>
                                    <div class="text-sm-end text-center mt-sm-0 mt-2">
                                        <span class="badge badge-md badge-success fs-16 mb-2">3.0</span>
                                        <div class="star-icons wspace-no">
                                            <i class="las la-star"></i>
                                            <i class="las la-star"></i>
                                            <i class="las la-star"></i>
