                                ...
                                <table id="all_workers" class="table table-striped mb-4 dataTablesCard fs-14">
                                    <thead class="bg-light text-dark border-bottom">
                                        <tr class="align-middle text-nowrap">
                                            <th><i class="fa fa-hashtag me-1"></i>{{ trans('messages.sr_no') }}</th>
                                            <th><i class="fa fa-user me-1"></i>{{ trans('messages.worker_name') }}</th>
                                            <th><i class="fa fa-phone me-1"></i>{{ trans('messages.phone') }}</th>
                                            ...
                                            <th><i class="fa fa-cogs me-1"></i>{{ trans('messages.action') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
                                ...
                                <div class="col-lg-4 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker location_id" name="location_id"
                                            data-live-search="true">
                                            <option value="">
                                                {{ trans('messages.choose', [], session('locale')) }}...
                                            </option>
