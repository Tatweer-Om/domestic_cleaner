                            ...
                            <table id="example5" class="table table-striped patient-list mb-4 dataTablesCard fs-14">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>22 Mar 2021</td>
                                        <td class="text-end">
                                            <a href="staff-profile.html" class="me-3"><i class="fa fa-eye fs-18"></i></a>
                                            <a href="javascript:void(0);" class="edit-staff me-3"><i class="fa fa-pencil fs-18 text-success"></i></a>
                                            <a href="javascript:void(0);"><i class="fa fa-trash fs-18 text-danger"></i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
