...
@section('main')
    @push('title')
        <title>  {{ trans('messages.driver_credentials', [], session('locale')) }}</title>
    @endpush
    <style>
            ...
            <div
                ...
                <div>
                    <h3 class="fw-bold text-primary mb-1 d-flex align-items-center">
                        <i class="bi bi-person-lines-fill me-2"></i> {{ trans('messages.driver_credentials', [], session('locale')) }}
                    </h3>
