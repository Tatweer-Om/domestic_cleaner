                                ...
                                <thead class="bg-light">
                                    <tr>
                                        ...
                                        <th><i class="fas fa-map-marked-alt me-1"></i>
                                            {{ trans('messages.location_name', [], $locale) }}
                                        </th>
                                        <th><i class="fas fa-dollar-sign me-1"></i>
                                            {{ trans('messages.location_fare', [], $locale) }}
                                        </th>
                                        <th><i class="fas fa-dollar-sign me-1"></i>
                                            {{ trans('messages.driver_available', [], $locale) }}
                                        </th>
                                        <th><i class="fas fa-user me-1"></i>
                                            {{ trans('messages.added_by', [], $locale) }}
                                        </th>

                                        <th><i class="fas fa-calendar-alt me-1"></i>
                                            {{ trans('messages.added_on', [], $locale) }}
                                        </th>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div id="map-status" class="text-muted mt-2">
                                <span id="map-status-text">No Area Selected</span>
                                <span id="map-loading" style="display: none;">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control notes" rows="4"
                                    placeholder="{{ trans('messages.notes', [], $locale) }}" name="notes"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="driver_status" value="1" id="driver_available">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="driver_status" value="2" id="driver_unavailable">
